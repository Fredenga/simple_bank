...
// Source: github.com/fredrick/simplebank/db/sqlc (interfaces: Store)
...
import (
	context "context"
	sqlc "github.com/fredrick/simplebank/db/sqlc"
...
func (m *MockStore) AddAccount(arg0 context.Context, arg1 sqlc.AddAccountParams) (sqlc.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccount(arg0 context.Context, arg1 int32) (sqlc.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int32) (sqlc.Account, error) {
	m.ctrl.T.Helper()
